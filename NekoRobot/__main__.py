...
buttons = [
    ...
    [
        InlineKeyboardButton(text="🦄 ᴜᴘᴅᴀᴛᴇs", url=f"https://t.me/sayaneko"),
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ",
                            callback_data="https://t.me/sayaneko",
                        ),
                    ],
                    [
...
And suing [SQlalchemy](https://www.sqlalchemy.org) and [Mongo](https://cloud.mongodb.com) as Database.
   ...
   [𝐆𝐄𝐓🌱𝐑𝐄𝐏𝐎🍁](https://t.me/OwnNeko)
   
©2022-2023 @NekoLocal, All rights reserved.
""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
